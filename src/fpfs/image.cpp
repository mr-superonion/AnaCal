...
FpfsDeepWideImage::FpfsDeepWideImage(
    int nx,
    int ny,
    double scale,
    double sigma_arcsec,
...
py::array_t<double>
FpfsDeepWideImage::smooth_image(
    const py::array_t<double>& img_array,
    const py::array_t<double>& psf_array,
    bool do_rotate,
    int xcen,
...
py::array_t<double>
FpfsDeepWideImage::measure_source(
    const py::array_t<double>& gal_array,
    const py::array_t<std::complex<double>>& filter_image,
    const py::array_t<double>& psf_array,
    const std::optional<py::array_t<FpfsPeaks>>& det,
...
pyExportFpfsImage(py::module_& fpfs) {
    ...
    py::class_<FpfsDeepWideImage>(fpfs, "FpfsDeepWideImage")
        .def(py::init<
                int, int, double, double, double,
                bool, int, int
            >(),
            "Initialize the FpfsDeepWideImage object using an ndarray",
            py::arg("nx"), py::arg("ny"),
            py::arg("scale"),
            py::arg("sigma_arcsec"),
            py::arg("klim"),
